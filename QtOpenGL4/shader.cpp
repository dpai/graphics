...
void Shader::init(const char *vsFile, const char *fsFile) {
	...
	//glBindAttribLocation(shader_id, 2, "in_Position"); // Bind a constant attribute location for positions of vertices
	//glBindAttribLocation(shader_id, 3, "in_Color"); // Bind another constant attribute location, this time for color
